public class rectButton
{
  ...
  public rectButton(String str_thread, float float_X_coordinate, float float_Y_coordinate, float float_width, float float_height, boolean b_withHook, int int_global_ID)
  {
